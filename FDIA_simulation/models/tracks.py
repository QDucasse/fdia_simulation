...
if __name__ == "__main__":
    ...
    plot_track(xs_cruise, ys_cruise, zs_cruise, 1)

    test_track = Track()
    print('##== Figure 2: Weave mode ==========##')
    xs_weave, ys_weave, zs_weave = test_track.gen_weave()
    plot_track(xs_weave, ys_weave, zs_weave, 2)

    test_track = Track()
    print('##== Figure 3: Acceleration mode ===##')
    xs_acc, ys_acc, zs_acc = test_track.gen_acc()
    plot_track(xs_acc, ys_acc, zs_acc, 3)

    test_track = Track()
    print('##== Figure 4: Dive mode ===========##')
    xs_dive, ys_dive, zs_dive = test_track.gen_dive()
    plot_track(xs_dive, ys_dive, zs_dive, 4)

    test_track = Track()
    print('##== Figure 5: 1g turn mode ========##')
    xs_turn1, ys_turn1, zs_turn1 = test_track.gen_turn1()
    plot_track(xs_turn1, ys_turn1, zs_turn1, 5)

    test_track = Track()
    print('##== Figure 6: 5g turn mode ========##')
    xs_turn5, ys_turn5, zs_turn5 = test_track.gen_turn5()
    plot_track(xs_turn5, ys_turn5, zs_turn5, 6)

    test_track = Track()
    print('##== Figure 7: Offensive mode ======##')
    xs_off, ys_off, zs_off = test_track.gen_offensive()
    plot_track(xs_off, ys_off, zs_off, 7)

    test_track = Track()
    print('##== Figure 8: Defensive mode ======##')
    xs_def, ys_def, zs_def = test_track.gen_defensive()
    plot_track(xs_def, ys_def, zs_def, 8)

    test_track = Track()
    print('##== Figure 9: Defensive mode ======##')
    xs_dis, ys_dis, zs_dis = test_track.gen_disengagement()
    plot_track(xs_dis, ys_dis, zs_dis, 9)

    test_track = Track()
    print('##== Figure 10: Takeoff mode =======##')
    xs_toff, ys_toff, zs_toff = test_track.gen_takeoff()
    plot_track(xs_toff, ys_toff, zs_toff, 10)

    test_track = Track()
    print('##== Figure 11: Landing mode =======##')
    xs_land, ys_land, zs_land = test_track.gen_landing()
    plot_track(xs_land, ys_land, zs_land, 11)
