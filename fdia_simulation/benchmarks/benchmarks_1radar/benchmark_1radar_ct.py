...
if __name__ == "__main__":
    ...
    radar_filter_ct = RadarFilterCT(dim_x = 9, dim_z = 3, q = 3600., x0=x0,y0=y0,z0=z0, radar = radar)

    benchmark_ct = Benchmark(radars = radar,radar_filter = radar_filter_ct,states = states)
