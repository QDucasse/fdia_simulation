...
class Benchmark1RadarTestCase(unittest.TestCase):
    def setUp(self):
        # Radar definition
        ...
        self.benchmark_ca   = Benchmark(radars = self.radar, radar_filter = self.radar_filter_ca,   states = self.states)
        self.benchmark_cv   = Benchmark(radars = self.radar, radar_filter = self.radar_filter_cv,   states = self.states)
        self.benchmark_ct   = Benchmark(radars = self.radar, radar_filter = self.radar_filter_ct,   states = self.states)
        self.benchmark_ta   = Benchmark(radars = self.radar, radar_filter = self.radar_filter_ta,   states = self.states)
        self.benchmark_imm3 = Benchmark(radars = self.radar, radar_filter = self.radar_filter_imm3, states = self.states)
    # ==========================================================================
    # ======================== Initialization tests ============================

    def test_initialization_radars_1radar(self):
        self.assertEqual([self.radar],self.benchmark_ca.radars)
        self.assertEqual([self.radar],self.benchmark_cv.radars)
        self.assertEqual([self.radar],self.benchmark_ct.radars)
        self.assertEqual([self.radar],self.benchmark_ta.radars)
        self.assertEqual([self.radar],self.benchmark_imm3.radars)
    ...
    def test_gen_data_set(self):
        ...
        self.assertFalse(self.benchmark_ta.labeled_values)
        self.assertFalse(self.benchmark_imm3.labeled_values)
        self.assertEqual(np.shape(self.benchmark_ca.measured_values),(100,3))
        self.assertEqual(np.shape(self.benchmark_cv.measured_values),(100,3))
        self.assertEqual(np.shape(self.benchmark_ct.measured_values),(100,3))
        self.assertEqual(np.shape(self.benchmark_ta.measured_values),(100,3))
        self.assertEqual(np.shape(self.benchmark_imm3.measured_values),(100,3))
